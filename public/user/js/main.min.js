        ...
        (Wolmart.$window = t(window)),
            ...
            (Wolmart.initPopup = function (e, a) {
                Wolmart.$body.hasClass("home") &&
                    ...
                    /*setTimeout(function () {
                        Wolmart.popup({
                            items: { src: "assets/ajax/newsletter" },
                            type: "ajax",
                            tLoading: "",
                    ...
                    (function () {
                        ...
                        s.length ||
                            ...
                            (t(".page-wrapper").append(
                                '<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="product/compare" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'
                            ),
                            (s = t(".page-wrapper > .compare-popup"))),
                            Wolmart.$body
                                .on("click", ".product .btn-compare", function (o) {
                                    ...
                                    (i = !1),
                                        ...
                                        setTimeout(function () {
                                            r.removeClass("load-more-overlay loading"), r.toggleClass("w-icon-compare").toggleClass("w-icon-check-solid"), r.attr("href", "product/compare"), s.addClass("show");
                                        }, 500);
                                        ...
                                        t(".compare-popup li").each(function (t) {
                                            n[t] &&
                                                (this.innerHTML =
                                                    ...
                                                    n[t] +
                                                    '"/></figure></a>                                        <a href="#" class="btn btn-remove remove-compare " data-id="'+productId+'"><i class="w-icon-times-solid"></i></a>');
                                        }),
                                        (a = n.length),
                                        e();
                                })
