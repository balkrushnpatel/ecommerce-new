...
$( document ).delegate( ".btn-cart", "click", function() { 
	if(!$(this).hasClass("disabled")){ 
		var id = $(this).attr('data-id');
		color = '';
		option = '';

		if($('.cust-color.active').data('color') != ''){
...
$( document ).delegate( ".quantity-minus,.quantity-plus", "click", function() { 	  
	var id = $(this).attr('data-id');  
	var qty = $('#product_qty_'+id).val(); 
...
$( document ).delegate( ".track-order", "click", function() { 	  
	var orderId = $('#order_id').val();
	console.log(orderId);
		$.ajax({
		url: APP_URL + '/order/ordertrack',
		data : { 
			'id':orderId,
		},
		beforeSend: function() { 
...
function to_quickview(id){
	$.ajax({
		url: APP_URL + '/product/quickview',
		data : {
			'id':id
		},
		beforeSend: function() { 
...
$( document ).delegate( ".remove-compare", "click", function() { 	  
	var id = $(this).attr('data-id'); 
	$.ajax({
		url: APP_URL + '/removeComparePro',
		data : { 
			'id':id
		},
		beforeSend: function() { 
...
$( document ).delegate( ".btn-clean", "click", function() { 	  
...
function to_wishlist(id){
	$.ajax({
		url: APP_URL + '/user/wishlist/product',
		data : { 
			'id':id
		},
		beforeSend: function() { 
