...
@section('content')
@include('layouts.partials.sub-header',['pageHeader' => 'Banner'])
<!--begin::Entry-->
		...
		<div class="card card-custom">
			<div class="card-header flex-wrap py-3">
				<div class="card-title">
					...
					<span class="d-block text-muted pt-2 font-size-sm">Add &amp; Edit Banner</span></h3>
				</div> 
		  ...
		  <form id="banner-form"  class="form fv-plugins-bootstrap fv-plugins-framework" action="@yield('editId',route('banner.index'))" method="post" accept-charset="utf-8" role="form" enctype="multipart/form-data">
				{{csrf_field()}}
				@section('editMethod')
				@show  
				@csrf 
					    ...
					    <div class="col-sm-12 col-md-12"> 
					    	<div class="row">
					        	<div class="col-lg-4 form-group ">
							    	<label for="banner-name" class="col-form-label">Banner Name<span class="required">*</span></label>
							      	<input type="text" class="form-control" id="banner-name" value="{{ (isset($banner)) ? $banner->banner_name : '' }}" name="banner_name">
							      	<div class="fv-plugins-message-container"></div>
						        </div>  
								 <div class="col-lg-4 form-group ">
							    	<label for="banner-button" class="col-form-label">Button Name<span class="required">*</span></label>
							      	<input type="text" class="form-control" id="button-name" value="{{ (isset($banner)) ? $banner->btn_name : '' }}" name="btn_name">
							      	<div class="fv-plugins-message-container"></div>
						        </div>
						        <div class="col-lg-4 form-group ">
							    	<label for="banner-text" class="col-form-label">Text<span class="required">*</span></label>
							      	<input type="text" class="form-control" id="button-name" value="{{ (isset($banner)) ? $banner->text : '' }}" name="text">
							      	<div class="fv-plugins-message-container"></div>
						        </div>
						        <div class="col-lg-4 form-group ">
							    	<label for="banner-link" class="col-form-label">Link<span class="required">*</span></label>
							      	<input type="text" class="form-control" id="button-link" value="{{ (isset($banner)) ? $banner->link : '' }}" name="link">
							      	<div class="fv-plugins-message-container"></div>
						        </div>
					            <div class="col-lg-4 form-group ">
				...
				<div class="card-footer">
					<div class="row">
						<div class="col-lg-12">
							<a href="{{ route('banner.index')}}" class="btn btn-light-primary font-weight-bold">Cancel</a>
							<button type="submit" class="btn btn-light-success font-weight-bold mr-2">{{ isset($banner) ? 'Update' : 'Save' }} </button>
						</div>
					</div>
				</div>
			</form>
...
@endsection
@push('scripts')  
<script src="{{ asset('wjs/banner.js')}}"></script>
@endpush