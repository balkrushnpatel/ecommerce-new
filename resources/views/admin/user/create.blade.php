		...
		<div class="card card-custom">
			<div class="card-header flex-wrap py-3">
				<div class="card-title">
					...
					<span class="d-block text-muted pt-2 font-size-sm">Add &amp; Edit User</span></h3>
				</div> 
				<div class="card-toolbar">  
					<!--begin::Button-->
					<a href="{{ route('admin.userlist') }}" class="btn btn-primary font-weight-bolder">
		  ...
		  <form id="user-form"  class="form fv-plugins-bootstrap fv-plugins-framework" action="@yield('editId',route('admin.userstore'))" method="post" accept-charset="utf-8" role="form" enctype="multipart/form-data">
				{{csrf_field()}}
				@section('editMethod')
				@show  
				@csrf 
				<div class="card-body"> 
					<div class="row"> 
						<div class="col-sm-12 col-md-4 form-group">
	                        ...
	                        <input type="text" class="form-control" placeholder="Enter first name" id="first_name" value="{{ (isset($user)) ? $user->first_name : '' }}" name="first_name">
                        ...
                        <div class="col-sm-12 col-md-4 form-group">
	                        ...
	                        <input type="text" class="form-control" placeholder="Enter Lastname" id="last_name"  value="{{ (isset($user)) ? $user->last_name : '' }}" name="last_name">
	                        <div class="fv-plugins-message-container"></div>
                        </div> 
	                    <div class="col-sm-12 col-md-4 form-group">
	                        <label for="email" class="col-form-label"> Email <span class="text-danger"></span></label>
	                        <input type="text" class="form-control" placeholder="Enter email" id="email"  value="{{ (isset($user)) ? $user->email : '' }}" name="email">
	                        <div class="fv-plugins-message-container"></div>
	                    </div>
	                  
	                    <div class="col-sm-12 col-md-4 form-group">
		                    <label for="mobile_no" class="col-form-label">Mobile Number <span class="text-danger"></span></label>
	                        <input type="text" class="form-control" placeholder="Enter mobile no" id="mobile no" value="{{ (isset($user)) ? $user->mobile_no : '' }}" name="mobile_no">
	                        <div class="fv-plugins-message-container"></div>
		                </div>
						<div class="col-sm-12 col-md-4 form-group">
							<label for="user-image" class="col-form-label">Image </label> 
							<input type="file" class="form-control" id="user-image"value="{{ (isset($user)) ? $user->image : '' }}" name="image">
							<div class="fv-plugins-message-container"></div>
						</div> 
					</div> 
				</div>
				<div class="card-footer">
					<div class="row">
						<div class="col-lg-12">
							<a href="{{ route('admin.userlist')}}" class="btn btn-light-primary font-weight-bold">Cancel</a>
							<button type="submit" class="btn btn-light-success font-weight-bold mr-2">{{ isset($user) ? 'Update' : 'Save' }} </button>
						</div>
					</div>
				</div>
			</form>
