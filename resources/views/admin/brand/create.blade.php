		...
		<div class="card card-custom">
			<div class="card-header flex-wrap py-3">
				<div class="card-title">
					...
					<span class="d-block text-muted pt-2 font-size-sm">Add &amp; Edit Brand</span></h3>
				</div> 
				<div class="card-toolbar">  
					<!--begin::Button-->
					<a href="{{ route('brand.index') }}" class="btn btn-primary font-weight-bolder">
		  ...
		  <form id="brand-form"  class="form fv-plugins-bootstrap fv-plugins-framework" action="@yield('editId',route('brand.index'))" method="post" accept-charset="utf-8" role="form" enctype="multipart/form-data">
				{{csrf_field()}}
				@section('editMethod')
				@show  
				@csrf 
					...
					<div class="row"> 
					    <div class="col-sm-12 col-md-12"> 
					    	<div class="form-group row">
					        	<div class="col-lg-12">
						    	<label for="brand-name" class="col-form-label"> Brand Name <span class="required">*</span></label>
						      	<input type="text" class="form-control" id="name" value="{{ (isset($brand)) ? $brand->name : '' }}" name="name">
						  	 	...
						  	 	<div class="col-lg-12">
	  	 							<div class="radio-inline">
										...
										<label class="radio radio-success">
											<input type="radio" name="status" value="1" {{ (isset($brand) && ($brand->status == 1) ) ? 'checked': ''}} >
											<span></span>Active
										</label>
										<label class="radio radio-success">
				...
				<div class="card-footer">
					<div class="row">
						<div class="col-lg-12">
							<a href="{{ route('brand.index')}}" class="btn btn-light-primary font-weight-bold">Cancel</a>
							<button type="submit" class="btn btn-light-success font-weight-bold mr-2">{{ isset($brand) ? 'Update' : 'Save' }} </button>
						</div>
					</div>
				</div>
			</form>
