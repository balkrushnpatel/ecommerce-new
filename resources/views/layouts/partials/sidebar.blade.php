			...
			<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
				...
				<li class="menu-item menu-item-submenu {{ $categoryActive }}" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle  {{ $categoryActive }} " >
						<i class="fab fa-creative-commons menu-icon"></i>
				...
				@php
					$productActive = '';
					if(Request::is('admin/product') || Request::is('admin/productstock')){
						$productActive = 'menu-item-open';
					}
				@endphp
				<li class="menu-item menu-item-submenu {{ $productActive }}" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle  {{ $productActive }} " >
						<i class="fab fa-product-hunt menu-icon"></i>
						<span class="menu-text">@lang('ecommerce.Product')</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
						<ul class="menu-subnav"> 
							<li class="menu-item {{ (Request::is('admin/product'))?'menu-item-open':'' }}" aria-haspopup="true">
							...
							<li class="menu-item {{ (Request::is('admin/productstock'))?'menu-item-open':'' }}" aria-haspopup="true">
								<a href="{{url('admin/productstock')}}" class="menu-link">
									<i class="menu-bullet menu-bullet-dot">
										<span></span>
									</i>
									<span class="menu-text">@lang('ecommerce.ProductStock')</span>
								</a>
							</li> 
						</ul>
					</div>
				...
				<li class="menu-item menu-item-submenu {{ $couponcodeActive }}">
					<a href="{{ url('admin/couponcode') }}" class="menu-link">
						...
						<span class="menu-text">@lang('ecommerce.CouponCode')</span> 
					</a> 
				</li>  
				@php
					$packageActive = '';
				...
				<li class="menu-item menu-item-submenu {{ $packageActive }}">
					<a href="{{ url('admin/package') }}" class="menu-link">
						...
						<span class="menu-text">@lang('ecommerce.Package')</span> 
					</a> 
				</li>
				@php
					$sliderActive = '';
